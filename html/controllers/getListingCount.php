...
$location_grade = $_POST['location_grade']; // Minimum Location grade from 1 to 10
$neighborhoods = $_POST['neighborhoods']; // Greenwich Village, Midtown, etc.
$prop_type = $_POST['prop_type']; // Co-op, Condo, Townhouse, etc.
$building_grade = $_POST['building_grade']; // Minimum Building grade from 1 to 10
$amens = $_POST['amenities']; // Doorman, Pool, etc.
$views_grade = $_POST['views_grade'];  // Minimum Views grade from 1 to 10
$min_floor = $_POST['min_floor'];  // The lowest acceptable floor, e.g. 8th floor. This feature is not currently available to users, but operational for future versions.
$max_price = $_POST['max_price']; // Maximum Price
$max_price = str_replace(",", "", $max_price);
$min_price = $_POST['min_price']; // Minimum Price
$min_price = str_replace(",", "", $min_price);
$bedrooms = $_POST['bedrooms']; // Minimum Number of Bedrooms
$living_area = $_POST['living_area']; // Minimum Size of Living Room
$bedroom_area = $_POST['bedroom_area']; // Minimum Size of Bedroom
