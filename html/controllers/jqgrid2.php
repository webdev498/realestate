...
while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
  ...
  if( strpos($bld, "gold") !== false ){
    $s .= "<cell><![CDATA[<img data-toggle='tooltip' title='Best' class='quality view-bubble-grades' style='cursor: pointer' alt='Best Building Match' src='http://homepik.com/" . $bld . "'/>]]></cell>";
  } elseif( strpos($bld, "silver") !== false ){
    $s .= "<cell><![CDATA[<img data-toggle='tooltip' title='Better' class='quality view-bubble-grades' style='cursor: pointer' alt='Better Building Match' src='http://homepik.com/" . $bld . "'/>]]></cell>";
  } elseif( strpos($bld, "bronze") !== false ){
    $s .= "<cell><![CDATA[<img data-toggle='tooltip' title='Satisfactory' class='quality view-bubble-grades' style='cursor: pointer' alt='Satisfactory Building Match' src='http://homepik.com/" . $bld . "'/>]]></cell>";
  } else{
  ...
  if( strpos($vws, "gold") !== false ){
    $s .= "<cell><![CDATA[<img data-toggle='tooltip' title='Best' class='quality view-bubble-grades' style='cursor: pointer' alt='Best Views Match' src='http://homepik.com/" . $vws . "'/>]]></cell>";
  } elseif( strpos($vws, "silver") !== false ){
    $s .= "<cell><![CDATA[<img data-toggle='tooltip' title='Better' class='quality view-bubble-grades' style='cursor: pointer' alt='Better Views Match' src='http://homepik.com/" . $vws . "'/>]]></cell>";
  } elseif( strpos($vws, "bronze") !== false ){
    $s .= "<cell><![CDATA[<img data-toggle='tooltip' title='Satisfactory' class='quality view-bubble-grades' style='cursor: pointer' alt='Satisfactory Views Match' src='http://homepik.com/" . $vws . "'/>]]></cell>";
  } else{
    $s .= "<cell><![CDATA[<img class='quality view-bubble-grades' style='cursor: pointer' alt='Views Match' src='http://homepik.com/" . $vws . "'/>]]></cell>";
  }

  if( strpos($spac, "gold") !== false ){
    $s .= "<cell><![CDATA[<img data-toggle='tooltip' title='Best' alt='Best Space Match' class='quality view-bubble-grades' style='cursor: pointer' src='http://homepik.com/" . $spac . "'/>]]></cell>";
