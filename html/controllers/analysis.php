...
if (isset($_POST['report-submit'])) {
  ...
  if (($listMonth == "blank") || ($listYear == "blank") || ($listArea == "blank"))
    ...
    if ($listArea == 'All Markets'){
      $sql = "SELECT COUNT(*) AS totalCount, bed FROM `vow_data` WHERE status = 'AVAIL' AND (((DATE_FORMAT(STR_TO_DATE(list_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(list_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') <= '" . $listEndDate . "'))) GROUP BY bed";
    } else {
      if ($listArea == 'North'){
        $sql = "SELECT COUNT(*) AS totalCount, bed FROM `vow_data` WHERE (nbrhood = 'E-North' OR nbrhood = 'W-North') AND status = 'AVAIL' AND (((DATE_FORMAT(STR_TO_DATE(list_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(list_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') <= '" . $listEndDate . "'))) GROUP BY bed";
      } else {
        $sql = "SELECT COUNT(*) AS totalCount, bed FROM `vow_data` WHERE nbrhood = '" . $listArea . "' AND status = 'AVAIL' AND (((DATE_FORMAT(STR_TO_DATE(list_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(list_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') <= '" . $listEndDate . "'))) GROUP BY bed";
      }
    }
    ...
    if ($listArea == 'All Markets'){
      $sql = "SELECT COUNT(*) AS bedCount, bed FROM `vow_data` WHERE (((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') <= '" . $listEndDate . "'))) AND status <> 'AVAIL' GROUP BY bed";
    } else {
      if ($listArea == 'North') {
        $sql = "SELECT COUNT(*) AS bedCount, bed FROM `vow_data` WHERE (nbrhood = 'E-North' OR nbrhood = 'W-North')  AND (((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') <= '" . $listEndDate . "'))) AND status <> 'AVAIL' GROUP BY bed";
      } else {
        $sql = "SELECT COUNT(*) AS bedCount, bed FROM `vow_data` WHERE nbrhood = '" . $listArea . "' AND (((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') <= '" . $listEndDate . "'))) AND status <> 'AVAIL' GROUP BY bed";
      }
    }
...
if (isset($_POST['listings-yearly'])) {
  ...
  if (($listYearlyArea == "blank"))
    ...
    if ($listYearlyArea == 'All Markets'){
      $sql = "SELECT COUNT(*) AS totalCount, bed FROM `vow_data` WHERE  (((DATE_FORMAT(STR_TO_DATE(list_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(list_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') <= '" . $listEndDate . "'))) GROUP BY bed";
    } else {
      if ($listYearlyArea == 'North'){
        $sql = "SELECT COUNT(*) AS totalCount, bed FROM `vow_data` WHERE nbrhood = 'E-North' OR nbrhood = 'W-North' AND  (((DATE_FORMAT(STR_TO_DATE(list_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(list_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') <= '" . $listEndDate . "'))) GROUP BY bed";
      } else {
        $sql = "SELECT COUNT(*) AS totalCount, bed FROM `vow_data` WHERE nbrhood = '" . $listYearlyArea . "' AND  (((DATE_FORMAT(STR_TO_DATE(list_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(list_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') <= '" . $listEndDate . "'))) GROUP BY bed";
      }
    }
	  //$sql = "SELECT COUNT(*) AS totalCount, bed FROM `vow_data` WHERE nbrhood = '" . $listArea . "' AND status = 'AVAIL' AND (((DATE_FORMAT(STR_TO_DATE(list_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(list_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "'))) GROUP BY bed";
		$result = mysql_query( $sql ) or die("Couldn't execute query. New/Updated query error.".mysql_error());
    ...
    if ($listYearlyArea == 'All Markets'){
      ...
      if ($listYearlyArea == 'North') {
        ...
        $sql = "SELECT COUNT(*) AS bedCount, bed FROM `vow_data` WHERE nbrhood = '" . $listYearlyArea . "' AND (((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) OR ((DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(last_change_date, '%m-%d-%Y'), '%Y-%m-%d') <= '" . $listEndDate . "'))) AND status <> 'AVAIL' GROUP BY bed";
      }
    }
	 //$sql = "SELECT COUNT(*) AS bedCount, bed FROM `vow_data` WHERE nbrhood = '" . $listArea . "' AND ((DATE_FORMAT(STR_TO_DATE(list_date, '%m/%d/%Y'), '%Y-%m-%d') >= '" . $listBegDate . "') AND (DATE_FORMAT(STR_TO_DATE(list_date, '%m/%d/%Y'), '%Y-%m-%d') <= '" . $listEndDate . "')) AND status <> 'AVAIL' GROUP BY bed";
  $result = mysql_query( $sql ) or die("Couldn't execute query. Sold/off-market query error.".mysql_error());
...
<?php
  ...
  //echo $agentCode;
    ...
    //$sql = "SELECT COUNT(*) AS buyerCount FROM `users` WHERE P_agent = '" . $agentCode . "'";
	if ($agentArea == 'All Markets'){
		$sql = "SELECT COUNT(*) AS buyerListingCount, list_num FROM `users`, `saved_listings` JOIN `vow_data` ON list_num = list_numb WHERE user = email AND time >= '" . $rtimeBegDate . "' AND time <= '" . $rtimeEndDate . "' AND (P_agent = '" . $agentCode . "' OR P_agent2 = '" . $agentCode . "')";
    } else {
		if ($agentArea == 'North') {
				$sql = "SELECT COUNT(*) AS buyerListingCount, list_num FROM `users`, `saved_listings` JOIN `vow_data` ON list_num = list_numb WHERE user = email AND (nbrhood = 'W-North' OR nbrhood = 'E-North') AND (time >= '" . $rtimeBegDate . "' AND time <= '" . $rtimeEndDate . "') AND (P_agent = '" . $agentCode . "' OR P_agent2 = '" . $agentCode . "')";
			} else  {
				$sql = "SELECT COUNT(*) AS buyerListingCount, list_num FROM `users`, `saved_listings` JOIN `vow_data` ON list_num = list_numb WHERE user = email AND nbrhood = '" . $agentArea . "' AND (time >= '" . $rtimeBegDate . "' AND time <= '" . $rtimeEndDate . "') AND (P_agent = '" . $agentCode . "' OR P_agent2 = '" . $agentCode . "')";
			}	
		}
...
if (isset($_POST['agent-yearly'])) {
  ...
  //  $result = mysql_query( $sql ) or die("Couldn't execute query.".mysql_error());
    ...
    //$sql = "SELECT COUNT(*) AS buyerCount FROM `users` WHERE P_agent = '" . $agentCode . "'";
	if ($agentYearlyArea == 'All Markets'){
		$sql = "SELECT COUNT(*) AS buyerListingCount, list_num FROM `users`, `saved_listings` JOIN `vow_data` ON list_num = list_numb WHERE user = email AND saved_listings.agent = '" . $agentYearlyCode . "' AND time >= '" . $rtimeBegDate . "' AND time <= '" . $rtimeEndDate . "'";
    } else {
		if ($agentYearlyArea == 'North') {
		$sql = "SELECT COUNT(*) AS buyerListingCount, list_num FROM `users`, `saved_listings` JOIN `vow_data` ON list_num = list_numb WHERE user = email AND saved_listings.agent = '" . $agentYearlyCode . "' AND (nbrhood = 'W-North' OR nbrhood = 'E-North') AND (time >= '" . $rtimeBegDate . "' AND time <= '" . $rtimeEndDate . "')";
			} else  {
				$sql = "SELECT COUNT(*) AS buyerListingCount, list_num FROM `users`, `saved_listings` JOIN `vow_data` ON list_num = list_numb WHERE user = email AND saved_listings.agent = '" . $agentYearlyCode . "' AND nbrhood = '" . $agentYearlyArea . "' AND (time >= '" . $rtimeBegDate . "' AND time <= '" . $rtimeEndDate . "')";
			}	
		}
