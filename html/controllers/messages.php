...
<div id="passwords_dont_match" class="text-popups"><p>New password and confirm password do not match.</p></div>
<div id="blank_name" class="text-popups"><p>Name can not be blank. Please enter a first and last name</p></div>
<div id="invalid_name" class="text-popups"><p>Your first and/or last name is invalid. They cannot contain numeric values.<p></div>
<div id="blank_email" class="text-popups"><p>Email can not be blank. Please enter a valid email address.</p></div>
<div id="invalid_email" class="text-popups"><p>The email entered is invalid. Please enter a valid email address.</p></div>
<div id="blank_phone" class="text-popups"><p>Phone can not be blank. Please enter a 10 digit phone number.</p></div>
<div id="invalid_phone" class="text-popups"><p>The number entered is invalid. Please enter a 10 digit phone number.</p></div>
<div id="invalid_information" class="text-popups"><p>The information entered did not match the information on file.</p></div>
<div id="add_buyer_blank" class="text-popups"><p>You must enter a first name, last name and email to add a new buyer.</p></div>
<div id="add_buyer_valid_emails" class="text-popups"><p>Accounts with @bellmarc.com can not be added as buyers.</p></div>
<div id="add_buyer_added_confirmation" class="text-popups"><p>Buyer has been added and an email containing an invitation to HomePik and the New York State Disclosure Form for Buyer and Seller has been sent.</p></div>
<div id="add_buyer_exists_made_primary" class="text-popups"><p>An account already exists for this buyer. You have been made their primary agent.</p></div>
<div id="add_buyer_exists_made_secondary" class="text-popups"><p>An account already exists for this buyer and they have one primary agent. You have been made their second primary agent.</p></div>
<div id="add_buyer_already_agent" class="text-popups"><p>An account already exists for this buyer and you are already this buyer's agent.</p></div>
<div id="add_buyer_exists_max_agents" class="text-popups"><p>An account already exists for this buyer and they already have the limited amount of primary agents.</p></div>
<div id="activity_report_need_date" class="text-popups"><p>You must select at least a month and a year in order to view an activities report.</p></div>
<div id="activity_report_invalid_date" class="text-popups"><p>The date entered is invalid. Please enter a valid date to continue.</p></div>
