...
?>
  ...
  <?php include_css("/views/css/listing-detail.css"); ?>
</head>
<body>
  <div id="listing"></div>
  <div id="footer"></div>
...
<script type="text/babel">
	var Broker = React.createClass({
      ...
      return(
        <div>
          ...
          <p className="Text-3--2-kern">&nbsp;</p>
          <p className="Text-3--2-kern" style={{textAlign: "left"}}>Contact: {this.props.contact}</p>
          <p className="Text-3--2-kern" style={{textAlign: "left"}}>Email: {this.props.contact_email}</p>
          <p className="Text-3--2-kern" style={{textAlign: "left"}}>Phone: {this.props.contact_phone}</p>
          <p className="Text-3--2-kern">&nbsp;</p>
        ...
        <div className="clearfix grpelem">
          <div className="clearfix grpelem" id="pu2951-27">
            <div className="clearfix grpelem" id="u2951-27">
              ...
              <h4 className="text-popups" id="u2951-9"><span id="u2951-4"><input type="checkbox" name="sendee" value="friend" onChange={this.handleCheckbox.bind(this, "friend")}></input></span><span id="u2951-5">&nbsp;&nbsp; </span><span id="u2951-6">To a friend</span>&nbsp;&nbsp;&nbsp;&nbsp; <span id="u2951-8">enter address</span></h4>
              <h4 className="text-popups" id="u2951-14"><span id="u2951-10"><input type="checkbox" name="sendee" value="agent" onChange={this.handleCheckbox.bind(this, "agent")}></input></span><span id="u2951-11">&nbsp;&nbsp; </span><span id="u2951-12">To the agent</span>&nbsp;&nbsp; {this.props.agent_email}</h4>
              {this.checkAgent2() ? <h4 className="text-popups" id="u2951-14"><span id="u2951-10"><input type="checkbox" name="sendee" value="agent2" onChange={this.handleCheckbox.bind(this, "agent2")}></input></span><span id="u2951-11">&nbsp;&nbsp; </span><span id="u2951-12">To the agent</span>&nbsp;&nbsp; {this.props.agent2_email}</h4> : null }
            ...
            <input type="text" name="email" value={this.state.email} id="u2950" className="text ui-widget-content ui-corner-all text-popups" onChange={this.handleChange.bind(this,"email")}></input>
          </div>
	...
	var GuestSave = React.createClass({
	  closePopup: function(){
      $(".guestSave").hide();
	  },
	  render: function(){
      return(
        <div className="clearfix grpelem guestSave" id="u26523">
          <div className="clip_frame grpelem" id="u26513">
            <img className="block" id="u26513_img" src="/images/box_246x168.png" alt="" width="300" height="300"/>
          </div>
          <div className="Text-3--2-kern clearfix grpelem" id="u17440-10">
            <p id="u17440-2">You cannot save listings without an account.</p>
            <p>To create an account, <br/>click <span id="u17440-6"><a href="guest-register.php">here</a></span>.</p>
          </div>
          <div className="text-popups clearfix grpelem" id="u4313-4">
            <h4 onClick={this.closePopup}><i className="fa fa-times" title="close"></i></h4>
          </div>
        </div>
      );
	...
	var AgentSaveOld = React.createClass({
	  ...
	  setBuyer: function(event){
      this.setState({buyer: event.target.value});
      this.setState({newFolder: false});
      this.setState({folder: ""});
      if(this.state.user != event.target.value){ this.getBuyerFolders(event.target.value); }
      else{ this.setState({folders: this.props.folders}); }
	  },
	  getBuyerFolders: function(buyer){
      $.ajax({
        type: "POST",
        url: "get-buyer-folders.php",
        data: {"buyer":buyer, "agentID":this.state.agent_id},
        success: function(data){
      ...
      var buyers = this.state.buyers.map(function(buyer){
        return(
          <option key={buyer.id} id={buyer.id} value={buyer.email}>{buyer.last_name}, {buyer.first_name}</option>
        );
      }.bind(this));
      ...
      return(
        <div>
          ...
          <h4 className="text-popups" id="u1330-5">Select a buyer:</h4>
          <h4 className="text-popups" id="u1330-3">&nbsp;</h4>
          <select onChange={this.setBuyer}>
            <option id="agent" value={this.state.user} selected>My Folders</option>
            {buyers}
          </select>
          <h4 className="text-popups" id="u1330-3">&nbsp;</h4>
          <h4 className="text-popups" id="u1330-3">&nbsp;</h4>
  ...
  var AgentSave = React.createClass({
      ...
      return(
        <div>
          ...
          <div className="clearfix grpelem" id="u1971-5">
            <p style={{cursor: "pointer"}} onClick={this.closePopup}><span id="u1971-2"><i className="fa fa-times" title="close"></i></span></p>
          </div>
        </div>
      );
	  }
	...
	var CostEstimator = React.createClass({
	  ...
	  componentDidMount: function(){
      var price = this.props.price.replace(',','');
      var maint = this.props.maint.replace(',','');
      var taxes = this.props.taxes.replace(',','');
      this.setState({bid: price});
	  ...
	  calculate:function(){
      var price = this.state.bid;
      var monthly = this.state.maint;
              ...
              <div className="row">
                <div className="col-md-4 col-sm-6 col-xs-12 first-section">
                  <div className="clip_frame clearfix grpelem" id="u8771">
                    <img className="position_content" id="bigImage" src={this.state.photo} alt=""/>
                      ...
                      <table className="Text-3--2-kern" id="u8770-20">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><a style={{cursor: "pointer"}} onClick={this.save} title="Save Listing" ><i className="fa fa-heart"></i></a></td>
                          ...
                          <tr className="Icon-labels" id="u8770-24">
                            ...
                            <td style={{textAlign: "center"}}>Cost Estimator</td>
                          </tr>
                        </tbody>
                      </table>
              ...
              <div className="row">
                <div className="col-md-8 col-sm-8 col-xs-12 fourth-section">
                  <div className="clearfix grpelem" id="u8796-17">
                    ...
                    {this.state.details['broker'] != '' ? <p className="Text-3--2-kern" id="u8796-15">Courtesy of {this.state.details['broker']}</p> : <p className="Text-3--2-kern" id="u8796-15">Courtesy of {this.state.details['contract']}</p> }
                  </div>
                </div>
